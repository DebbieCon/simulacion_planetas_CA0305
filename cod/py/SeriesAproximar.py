...
class SeriesAproximar:
    def __init__(self, m, k=0.07436680):
        ...
        Parámetros:
        - m: masa del cuerpo en términos de la masa del cuerpo central
        - k: constante gravitacional gaussiana (por defecto para sistema geocéntrico)
        """
        self.m = m
        self.k = k
        self.mu = 1 + m
    ...
    def compute_initial_parameters(self, r0_vec, v0_vec):
        ...
        Parámetros:
        - r0_vec: vector de posición inicial [x0, y0, z0]
        - v0_vec: vector de velocidad inicial [vx0, vy0, vz0]
        
        Retorna:
        - r0: distancia inicial
        - lambda0: parámetro lambda inicial
        - psi0: parámetro psi inicial
        """
    ...
    def compute_FG_series(self, tau, r0, lambda0, psi0, n_terms=10):
        ...
        Parámetros:
        - tau: tiempo modificado τ = k(t - t0)
        - r0: distancia inicial
        - lambda0: parámetro lambda inicial
        - psi0: parámetro psi inicial
        - n_terms: número de términos a usar en la serie (máx 10)
        
        Retorna:
        - F, G: valores de las series F(τ) y G(τ)
        - F_prime, G_prime: derivadas de las series
        """
        F = 0.0
        G = 0.0
        F_prime = 0.0
    ...
    def solve(self, t, t0, r0_vec, v0_vec, n_terms=10):
        ...
        - r0_vec: vector de posición inicial [x0, y0, z0]
        - v0_vec: vector de velocidad inicial [vx0, vy0, vz0]
        - n_terms: número de términos a usar en las series (máx 10)
        
        Retorna:
        - r_vec: vector de posición en tiempo t [x, y, z]
        - v_vec: vector de velocidad en tiempo t [vx, vy, vz]
        - r: distancia en tiempo t
        - v: velocidad en tiempo t
        """
